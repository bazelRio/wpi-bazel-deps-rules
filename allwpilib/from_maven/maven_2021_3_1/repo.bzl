...
def __third_party_allwpilib_java():
    repository_url = "https://frcmaven.wpi.edu/artifactory/release"

    deps = []
    deps.append(("allwpilib-wpimath-java", "edu.wpi.first.wpimath:wpimath-java:2021.3.1", "7e3e77bf3a28df3e7f0c12113fc2b0ec0050f9ab11a50182cafd4b2eeda7e076"))
    deps.append(("allwpilib-wpiutil-java", "edu.wpi.first.wpiutil:wpiutil-java:2021.3.1", "d35f31eafe9aafb508ab39c5d273ff6a33d594fd0a7409c8aa9ffcf21ec6fbb2"))
    deps.append(("allwpilib-ntcore-java", "edu.wpi.first.ntcore:ntcore-java:2021.3.1", "a18049c63220b1803f345498d447bcd23830aac1b23f533eaf082f74d626a7df"))
    deps.append(("allwpilib-cscore-java", "edu.wpi.first.cscore:cscore-java:2021.3.1", "6a706e56e7c71a201e0c2794fff48b59520990bb3a0aa8693b8e9e8a471242dc"))
    deps.append(("allwpilib-hal-java", "edu.wpi.first.hal:hal-java:2021.3.1", "545af9fa528be65e6a89c4aee355dece300a38b6861ff0d29a5638d5e479b961"))
    deps.append(("allwpilib-wpilibj-java", "edu.wpi.first.wpilibj:wpilibj-java:2021.3.1", "85f41c78832a9b14367e76d2f8ee24b9b7162ac8eca15c123d9b8a15550b3e5a"))
    deps.append(("allwpilib-cameraserver-java", "edu.wpi.first.cameraserver:cameraserver-java:2021.3.1", "ce387ca358d38ffbc390ea0478ebf835e40bd3c4f2c71d79bba4fcc7b4b0aa4c"))
    deps.append(("allwpilib-wpilibNewCommands-java", "edu.wpi.first.wpilibNewCommands:wpilibNewCommands-java:2021.3.1", "fbd0cf5269ef2f265ac1898aed87c075f7ba0ceef2de297c092d7870da8f757d"))
    deps.append(("allwpilib-wpilibOldCommands-java", "edu.wpi.first.wpilibOldCommands:wpilibOldCommands-java:2021.3.1", "7158b8b26586cb084ab0882b7a75d9749696932670ab5f73149768dea40fc99f"))
    ...
    artifacts = ["org.ejml:ejml-simple:0.38"] + []
